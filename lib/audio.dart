...
import 'package:mformatic_crm_delegate/buttonAudio.dart';
...
///
/// The [VoiceMessageViewMy] widget is used to display a voice message with customizable appearance and behavior.
...
///
class VoiceMessageViewMy extends StatelessWidget {
  const VoiceMessageViewMy(
      {Key? key,
      required this.controller,
      this.backgroundColor = Colors.white,
      this.activeSliderColor = const Color.fromARGB(255, 31, 31, 31),
      this.notActiveSliderColor,
      this.circlesColor = const Color.fromARGB(255, 0, 6, 12),
  ...
  final VoiceControllerMy controller;
