                ...
                children: [
                  ...
                  GetBuilder<RecordController>(
                    builder: (controller) {
                      return ElevatedButton(
                        onPressed:
                            controller.isPlaying || controller.audioPath.isEmpty
                                ? null
                        ...
                        builder: (controller) {
                          return GestureDetector(
                            ...
                            child: IconButton(
                                ...
                                icon: Icon(controller.isRecording != true
                              ...
                              ? VoiceMessageView(
                                  controller: VoiceController(
                                    ...
                                    maxDuration: Duration(
                                        seconds:
                                            controller.audioDuration.inSeconds),
                                    isFile: true,
                                    onComplete: () {
                                      // Do something on complete
                                    },
